...
type ResourceProvider interface {
	...
	// ClearCaches clears any cached actual state.
	// Called before forced reconciliation to ensure state is re-applied.
	// Providers without caches should provide an empty implementation.
	ClearCaches()
}
